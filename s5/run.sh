...
#   corpus=/media/Drive/wsj_data/wsj
...
#   rm data/local/dict/lexiconp.txt
  ...
  #     local/cstr_wsj_extend_dict.sh  $corpus/wsj1/wsj1/doc && \
  ...
  # for x in test_eval93 test_dev93 train_si284; do
  #   steps/make_mfcc.sh --cmd "$train_cmd" --nj 20 data/$x || exit 1;
  #   steps/compute_cmvn_stats.sh data/$x || exit 1;
  # done
